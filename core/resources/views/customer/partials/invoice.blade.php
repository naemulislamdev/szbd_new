        ...
        <table class="content-position">
            <tr>
                <th style="text-align: left">
                    <img height="70" width="200" src="{{ asset("assets/storage/company/$company_web_logo") }}"
                        alt="Shopping Zone BD Invoice Logo">
                </th>
                <th style="text-align: right">
                    <h1 style="color: #030303; margin-bottom: 0px; font-size: 30px;text-transform: capitalize">invoice
                    </h1>
                    @if ($order['seller_is'] != 'admin' && @$order['seller']->gst != null)
                        <h5 style="color: #030303; margin-bottom: 0px;text-transform: capitalize">GST
                            : {{ @$order['seller']->gst }}</h5>
                    @endif
                </th>
            </tr>
        ...
        <table class="bs-0">
            <tr>
                <th class="bg-primary content-position-y" style="padding-right: 0; height: 44px; text-align: left">
                    <div>
                        <span class="h4 inline text-white text-uppercase">invoice # </span>
                        <span class="inline">
        ...
        <div class="row">
            <section>
                <table class="content-position-y" style="width: 100%">
                    <tr>
                        <td valign="top">
                            <span class="h2" style="margin: 0px;">POS_order </span>
                ...
                <tbody>
                    @foreach ($order->details as $key => $details)
                        ...
                        <tr class="for-tb" style=" border: 1px solid #D8D8D8;margin-top: 5px">
                            ...
                            <td class="for-tb for-th-font-bold">{{ $details['price'] }}</td>
                            <td class="for-tb">{{ $details->qty }}</td>
                            <td class="for-tb for-th-font-bold">{{ $subtotal }}</td>
                        </tr>
            ...
            <tr>
                <th style="text-align: left; vertical-align: text-top;width:30%;">
                    ...
                    <h5 style="color: #414141 !important ; padding-top:5px;">
                        {{ str_replace('_', ' ', $order->payment_method) }}</h5>
                ...
                <th style="text-align: right;width:70%;">
                    <table style="width: 96%;margin-left:41%; display: inline "
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th class="gry-color text-left text-uppercase"><b>tax</b></th>
                                <td>{{ $total_tax }}</td>
                            </tr>
                            @if ($order->order_type == 'default_type')
                                <tr>
                            ...
                            @if ($order->order_type != 'default_type')
                                <tr class="border-bottom">
                                    <th class="gry-color text-left"><b>Dxtra discount</b></th>
                                    <td>
                                        - {{ $extra_discount }}</td>
                                </tr>
                            @endif
