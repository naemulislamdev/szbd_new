                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    @elseif($refund->status == 'approved')
                                        <span class="text-capitalize" style="color: rgb(21, 115, 255)">
                                            {{ $refund->status }}</span>
                                    @elseif($refund->status == 'refunded')
                                        <span class="text-capitalize" style="color: rgba(1, 255, 44, 0.979)">
                                            {{ $refund->status }}</span>
                                    @elseif($refund->status == 'rejected')
                                        <span class="text-capitalize" style="color: rgba(255, 42, 5, 0.979)">
                                            {{ $refund->status }}</span>
                                    @endif
                                </div>
