                    ...
                    <div class="card-header d-flex justify-content-between" style="padding: 5px;">
                        ...
                        <div>
                            <span> {{ $shippingAddress['address_type'] }} address
                                ({{ $shippingAddress['is_billing'] == 1 ? 'Billing_address' : 'Shipping address' }}) </span>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a class="" href="{{ route('address-delete', ['id' => $shippingAddress->id]) }}"
                                onclick="return confirm('Are you sure you want to Delete?');" id="delete">
                            ...
                            <div id="home" class="container tab-pane active"><br>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" placeholder="Enter your current address" id="address" type="text" name="address" required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
