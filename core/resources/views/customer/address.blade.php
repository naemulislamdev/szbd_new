...
@section('customer_content')
            ...
            <section class="col-lg-6 col-md-6 mb-4 mt-5">
                <div class="card" style="text-transform: capitalize;">
                    ...
                    <div class="card-header d-flex justify-content-between" style="padding: 5px;">
                        ...
                        <div>
                            <span> {{ $shippingAddress['address_type'] }} address
                                ({{ $shippingAddress['is_billing'] == 1 ? 'Billing_address' : 'Shipping address' }})
                            </span>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <form action="{{ route('address-delete', ['id' => $shippingAddress->id]) }}" method="POST"
                    ...
                    {{-- Modal Address Edit --}}
                    <div class="modal fade" id="editAddress_{{ $shippingAddress->id }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog  modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h5 class="modal-title font-name ">update address </h5>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <form id="updateForm">
                                            ...
                                            <div class="col-md-6" style="display: flex">
                                                ...
                                                <ul class="donate-now">
                                                    <li class="address_type_li">
                                                        ...
                                                        <label for="a25" class="component">permanent</label>
                                                    </li>
                                                    <li class="address_type_li">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="person_name">contact_person_name</label>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="own_state">State</label>
                                                <input type="text" class="form-control" name="state"
                                                    value="{{ $shippingAddress->state }}" id="own_state" placeholder=""
                                                    required>
                                            </div>
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-12">
                                                <label for="own_address">address</label>
                                                <input class="form-control" type="text" id="own_address"
                                                    name="address" value="{{ $shippingAddress->address }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-primary" id="addressUpdate"
                                                data-id="{{ $shippingAddress->id }}">update </button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="card-body"
                        ...
                        <div><span class="font-nameA"> <strong>Phone :</strong> {{ $shippingAddress['phone'] }}</span>
                        </div>
                        <div><span class="font-nameA"> <strong>City :</strong> {{ $shippingAddress['city'] }}</span>
                        </div>
                        <div><span class="font-nameA"> <strong> zip_code :</strong> {{ $shippingAddress['zip'] }}</span>
                        </div>
                        <div><span class="font-nameA"> <strong>address :</strong> {{ $shippingAddress['address'] }}</span>
                        </div>
    ...
    <div class="modal fade rtl" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog  modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="modal-title font-name ">Add new address</h5>
                        </div>
                    </div>
                </div>
                <div class="modal-body">
                            ...
                            <div id="home" class="container tab-pane active"><br>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control" type="number" id="zip" name="zip"
                                            required placeholder="Enter your zip code">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" placeholder="Enter your current address" id="address" type="text"
