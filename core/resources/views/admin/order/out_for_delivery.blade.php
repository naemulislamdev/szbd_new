        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                    <h4 class="page-title">Out For Delivery Order <span
                            class="badge bg-primary">{{ $orderCounts->out_for_delivery }}</h4>
                    <div class="">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Out For Delivery Order</li>
                        </ol>
                    </div>
