        ...
        <div class="row my-3">
            <div class="col-lg-12">
                ...
                <div class="card h-100">
                    ...
                    @if ($order->customer)
                        <div class="row">
                            <div class="col-lg-4 h-100" style="height: 100%;">
                                <div class="card-body cinfo-box h-100">
                                    <div
                                        class="media align-items-center d-flex align-items-center justify-content-between">
                                        <div class="avatar avatar-circle mr-3">
                                            @if ($order->customer->image != null && $order->customer->image != 'def.png')
                                                <img class="avatar-img" style="width: 75px;height: 42px"
                                                    ...
                                                    alt="Image">
                                            @else
                                                <img class="avatar-img" style="width: 75px;height: auto"
