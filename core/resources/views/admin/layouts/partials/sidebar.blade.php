...
<div class="d-flex align-items-start flex-column w-100">
    ...
    <ul class="navbar-nav mb-auto w-100">
        ...
        @endcanAny
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.trending-keyword.list') }}">
                <i class="la la-fire menu-icon"></i>
                <span>Trending Keywords</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.push-notification.list') }}">
                <i class="la la-bell menu-icon"></i>
            ...
            <li class="nav-item">
                ...
                <div class="collapse " id="reportsDropdown">
                    <ul class="nav flex-column">
                        ...
                        @can('product_report')
                            <li class="nav-item">
                                <a href="{{ route('admin.product_stock.index') }}" class="nav-link ">Product Stock
                                    Report</a>
                            </li><!--end nav-item-->
                        @endcan
                    </ul><!--end nav-->
