        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                    <h4 class="page-title">Role Department</h4>
                    <div class="">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active"> Role Department</li>
                        </ol>
                    </div>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h4 class="card-title">All Role Department</h4>
                            </div><!--end col-->
                            <div class="col-auto">
                                <div class="row mb-3">
                                    <div class="col-lg-12">
...
@push('scripts')
    ...
    <script>
        (function($) {
            ...
            const table = $('#szbd-datatable').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('admin.role_department.datatables') }}",
                },
                columns: [{
                        data: 'DT_RowIndex',
                        orderable: false,
            ...
            $(document).on('click', '.delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "{{ route('admin.role_department.delete') }}",
                            method: 'POST',
                            data: {
                                id: id
                            },
            ...
            $('#categoryForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.role_department.store') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(res) {
                        ...
                        toastr.success(res.message ?? 'Role Department added successfully');
                    },
                    error: function(err) {
            ...
            $('#editForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.role_department.update') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(res) {
                        ...
                        toastr.success(res.message ?? 'Role Department Updated successfully');
                    },
                    error: function(err) {
                        toastr.error(err.responseJSON.message ?? 'Something went wrong!');
                    }
    ...
    <script>
        $(document).on('change', '.status', function() {
            ...
            $.ajax({
                url: "{{ route('admin.role_department.status') }}",
                method: 'POST',
                data: {
                    id: id,
                    status: status
