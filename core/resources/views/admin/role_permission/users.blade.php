...
@push('scripts')
    ...
    <script>
        ...
        // Modal বন্ধ হলে password আবার hide করুন
        $('#addUserModal, #viewInvestorModal').on('hidden.bs.modal', function() {
            $(this).find('input[type="text"][name="password"]').attr('type', 'password');
            $(this).find('.togglePassword i').removeClass('la-eye-slash').addClass('la-eye');
        });
    </script>
    <script>
        (function($) {
