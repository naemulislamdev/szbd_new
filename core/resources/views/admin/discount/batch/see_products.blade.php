        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                    <h4 class="page-title">All Batch Products</h4>
                    <div class="">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Batch Products</li>
                        </ol>
                    </div>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h4 class="card-title">All Batch Products</h4>
                            </div><!--end col-->
    ...
    <script>
        (function($) {
            ...
            const table = $('#szbd-datatable').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('admin.discount.batch.products.datatables', $batchDiscount->product_ids) }}",
            ...
            $(document).on('click', '.delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "{{ route('admin.discount.batch.remove.product') }}",
                            method: 'POST',
                            data: {
                                id: id
                            },
                            success: function() {
                                toastr.success(
                                    'Product removed from batch discount successfully.'
                                );
                                table.ajax.reload();
