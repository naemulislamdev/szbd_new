        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                    <h4 class="page-title">All Offers <i class="las la-tags"></i></h4>
                    <div class="">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h4 class="card-title">All Offers Table</h4>
                            </div><!--end col-->
                            <div class="col-auto">
                                <div class="row mb-3">
                                    <div class="col-lg-12">
                                        <a href="{{ route('admin.discount.discount-offers.create') }}"
                                            class="btn btn-primary"><i class="la la-plus-circle"></i> Add New
                                            Offer</a>
                                    </div>
    ...
    <script>
        (function($) {
            ...
            const table = $('#szbd-datatable').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('admin.discount.offers.datatables') }}",
            ...
            $(document).on('click', '.delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "{{ route('admin.discount.offers.delete') }}",
                            method: 'POST',
                            data: {
                                id: id
                            },
