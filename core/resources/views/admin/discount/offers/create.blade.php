...
@section('title', 'Offer Discount create')
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                    <h4 class="page-title">Create Offer Discount <i class="las la-tags"></i></h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb   mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard.index') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('admin.discount.batch') }}">Offer
                                    Discount</a></li>
                            <li class="breadcrumb-item active">Create Offer Discount</li>
                        </ol>
                    </div>
                </div>
            </div>
