    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb   mb-0">
                            ...
                            <li class="breadcrumb-item active">Edit Offers & Promotionsr</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.discount.eid-offers.update', $eidoffer->id) }}" method="post"
                                            ...
                                            <select name="product_ids[]" id="productSelect"
                                                ...
                                                @foreach ($products as $product)
                                                    <option value="{{ $product->id }}" data-name="{{ $product->name }}"
                                                        ...
                                                        {{ in_array($product->id, json_decode($eidoffer->product_ids, true)) ? 'selected' : '' }}>
                                                        {{ $product->code }}</option>
                                                @endforeach
                                            </select>
                                            @error('product_ids.*')
                            ...
                            <div class="table">
                                <table class="table table-bordered">
                                    ...
                                    @php
                                        ...
                                        $discountAmounts = json_decode($eidoffer->discount_amount, true) ?? [];
                                        $discountTypes = json_decode($eidoffer->discount_type, true) ?? [];
                                    @endphp
