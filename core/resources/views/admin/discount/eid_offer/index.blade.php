                    ...
                    <div class="card-header pb-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <div class="row mb-3">
                                    <div class="col-lg-12">
                                        <a href="{{ route('admin.discount.eid-offers.create') }}" class="btn btn-primary"><i
    ...
    <script>
        (function($) {
            ...
            const table = $('#szbd-datatable').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('admin.discount.eid.offers.datatables') }}",
            ...
            $(document).on('click', '.delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "{{ route('admin.discount.eid-offers.delete') }}",
                            method: 'POST',
                            data: {
                                id: id
                            },
