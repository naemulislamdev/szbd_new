...
@section('title', 'Confirmed User Infos')
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                    <h4 class="page-title">Confirmed User Infos <span class="badge bg-success ms-2">Total: {{ $userInfoCounts->confirmed ?? 0 }}</span></h4>
                    <div class="">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Confirmed user info</li>
                        </ol>
                    </div>
    ...
    <script>
        (function($) {
            ...
            const table = $('#szbd-datatable').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('admin.userinfo.datatables', 'confirmed') }}",
                    data: function(d) {
