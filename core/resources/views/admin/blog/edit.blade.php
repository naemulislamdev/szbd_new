                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control @error('title') is-invalid @enderror"
                                        value="{{ $blog->title }}" type="text" name="title" id="title">
                                ...
                                <div class="col-md-6">
                                    <label for="slug">Blog Slug <span class="text-danger">*</span><small>(slug must be
                                            unique)</small></label>
                                    <input class="form-control @error('slug') is-invalid @enderror"
                                        value="{{ $blog->slug }}" type="text" name="slug" id="slug">
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <textarea name="meta_description" id="meta_description" cols="30" rows="10">{{ $blog->meta_description }}</textarea>
                                </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    <img style="width: 20%;border: 1px solid; border-radius: 10px;" id="viewer"
                                        src="{{ asset('assets/storage/blogs/' . $blog->image) }}" alt="" />
                                </div>
    ...
    <script>
        $(document).ready(function() {
            $('#description').summernote({
                followingToolbar: false, // toolbar scroll করবে না, fixed থাকবে
                height: 800,
            });
