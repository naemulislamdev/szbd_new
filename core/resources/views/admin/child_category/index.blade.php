        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                    <h4 class="page-title">All Child-Categories</h4>
                    <div class="">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="#">Dashboard</a>
                            </li><!--end nav-item-->
                            <li class="breadcrumb-item"><a href="#">Child-category</a>
                            </li><!--end nav-item-->
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select required class="form-select" name="sub_category_id" id="subCategoryId">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="text" name="name" id="subName" class="form-control"
                                    placeholder="Enter New Child-category" required>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form id="categoryForm" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="categoryModalLabel">Add New Child-Category</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select required class="form-select" name="sub_category_id" id="">
...
@push('scripts')
    ...
    <script>
        (function($) {
            ...
            const table = $('#szbd-datatable').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('admin.child-category.datatables') }}",
    ...
    <script>
        $(document).on('click', '.edit', function() {
            ...
            $('#subCategoryId').val(sub_category_id).trigger('change');
        });
    </script>
    <script>
