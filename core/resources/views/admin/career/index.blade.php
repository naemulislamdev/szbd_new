        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                    <h4 class="page-title">Job Posts</h4>
                    <div class="">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h4 class="card-title">All Job Posts</h4>
                            </div><!--end col-->
                            <div class="col-auto">
                                <div class="row mb-3">
                                    <div class="col-lg-12">
                                        <a href="{{ route('admin.career.create') }}" class="btn btn-primary"><i
    ...
    <script>
        (function($) {
            ...
            const table = $('#szbd-datatable').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('admin.career.datatables') }}",
                },
                columns: [{
                        data: 'DT_RowIndex',
                        orderable: false,
