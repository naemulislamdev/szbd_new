...
@section('content')
    <section>
        <div class="container mt-4">
            {{-- Bredcrumb start  --}}
            <nav class="breadcrumb custom-breadcrumb mt-2 mb-3">
                <a class="breadcrumb-item" href="{{ route('home') }}">Home</a>
                <span class="breadcrumb-item active" aria-current="page">{{ $discount_offers->title }}</span>
            </nav>
            {{--  Bredcrumb End --}}
            {{-- <div class="mb-4">
            ...
            <div class="row ">
                ...
                @if ($discount_offers->product_ids != null)
                    @php
                        ...
                        $discountOfferProducts = \App\Models\Product::whereIn('id', $productIds)->latest('id')->get();
                    @endphp
