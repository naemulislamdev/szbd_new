...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'Discover trending fashion and authentic beauty products with fast delivery across Bangladesh. Premium Clothing & Original Skincare | Shopping Zone BD')">
    {{-- Favicon Start  --}}
    <link rel="apple-touch-icon" href="{{ asset('assets/default/icons/szbd.png') }}">
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{ $web_config['fav_icon']->value
    ...
    <link rel="canonical" href="https://shoppingzonebd.com.bd/">
    <!-- Meta -->
    ...
    <style>
        ...
        /* swiper initial full width off css */
        /* .ProductSlider,
        ...
        .ProductSlider.swiper-initialized,
        .CategoryProductSlider.swiper-initialized {
            opacity: 1;
        } */
        /* .ProductSlider,
        .CategoryProductSlider {
...
<body class="toolbar-enabled" style="background: #fdf9f5;">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="d-flex align-items-center">
                        <img style="width: 55px;" src="{{ asset('assets/frontend/images/logo/whatsapp-2.png') }}"
                            alt="whatsapp icon">
                        <div class="ml-2 d-flex gx-3">
                            <a class="mb-0 text-white text-small d-block" target="_blank" title="Go Whatsapp"
                                style="font-size: 18px; font-weight: 600"
                                href="https://wa.me/8801406667669?text=Is%20anyone%20available%20to%20chat%3F">
                                01406-667669
                            </a>
                            <a class="mb-0 ml-4 text-white text-small" target="_blank" title="Go Whatsapp"
                                style="font-size: 18px; font-weight: 600 "
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-inline-block position-relative paymentTwo-box text-center">
                    ...
                    <div class="d-flex justify-content-between align-items-center gap-1 px-3 py-1 payment-hover-item">
                        <a title="WhatsApp"
                            href="https://wa.me/8801406667669?text=Is%20anyone%20available%20to%20chat%3F"
    ...
    <script>
        $(document).on('click', '.payment-2btn', function(e) {
            e.stopPropagation();
            var box = $(this).closest('.paymentTwo-box');
            var isActive = box.hasClass('active');
            $('.paymentTwo-box').removeClass('active'); // সব বন্ধ করো
            if (!isActive) {
                box.addClass('active'); // শুধু এটা খোলো
            }
        });
    ...
    <script>
        ...
        function addToCart(form_id, redirect_to_checkout = false) {
            ...
            if (!form_id) {
                ...
                console.log("Something went wrong! Form ID is missing.");
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // ❌ Out of stock
                    if (response.data === 0) {
                        Swal.fire('Stock Out', 'পণ্যটি বর্তমানে স্টকে নেই', 'error');
                        return;
                    }

                    // ⚠ Already in cart
                    if (response.data === 1) {
                        Swal.fire('Info', 'এই পণ্যটি ইতিমধ্যে কার্টে যোগ করা আছে !', 'info')
                            .then(() => {
                    ...
                    // ✅ Success
                    toastr.success('পণ্যটি কার্টে যোগ করা হয়েছে');
                ...
                error: function(e) {
                    // csrf token michmatch error page auto-reload
                    if (e.status === 419) {
                        location.reload();
                    }
                    $('#loading').hide();
                    Swal.fire('Error', 'অনুগ্রহ করে আবার চেষ্টা করুন!', 'error');
                }
            });
        }
    ...
    <script>
        const myOffcanvas = document.getElementById('searchOffcanvas');
