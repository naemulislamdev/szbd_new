...
@section('content')
    <div class="container mt-0 mt-lg-5 mb-5 px-0 px-lg-2">
            ...
            <div class="col-lg-7 mx-auto">
                <div class="card">
                    @if (auth('customer')->check())
                        ...
                        {{-- new card --}}
                        @php
                            $summary = \App\CPU\OrderManager::order_summary($order);
                            $extra_discount = 0;
                            ...
                            <div class="card-body ">
                                <div class="text-center">
                                    ...
                                    <h5 style="font-weight: 600;">
                                        {{ auth('customer')->user()->name ? auth('customer')->user()->name : auth('customer')->user()->f_name }}
                                    </h5>
                                </div>
                                ...
                                <div class="order_summery p-3 mt-3">
                                    ...
                                    <div class="row my-3 rounded">
                                        <div class="col-md-12 d-flex flex-column flex-lg-row pl-0">
                                                    ...
                                                    <tr>
                                                        <div class="row mb-2 w-100">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="col-10 for-glaxy-name pt-2 pl-5 "
...
@push('scripts')
    ...
    <script>
        ...
        window.dataLayer.push({
            'event': 'purchase',
            'eventID': '{{ $order->order_number }}', // new added
            '_fbp': fbp,
            '_fbc': fbc,
            'ecommerce': {
