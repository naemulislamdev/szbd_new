                ...
                <div class="carousel-inner">
                    @foreach ($main_banners as $key => $banner)
                        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                            <div class="main-slider  h-auto" style="height: auto">
...
@endif
                                 @php
                                    $choiceOptions = is_array($first_product->choice_options)
                                        ? $first_product->choice_options
                                        : json_decode($first_product->choice_options ?? '[]', true);
                                @endphp
