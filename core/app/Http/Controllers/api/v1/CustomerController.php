...
class CustomerController extends Controller
{
    ...
    /**
     * Authenticated password change (no OTP/SMS). The bearer token identifies the
     * user; they set a new password. Used so users on the phone-as-default
     * password can secure their account while OTP is off.
     */
    public function change_password(Request $request)
    {
        ...
        return response()->json(['message' => 'Password changed successfully', 'success' => '1'], 200);
    }
}
